...
- [通常dev環境](docs/normal-dev-environment-guide_ja.md): host-native Paperを`run.sh`／Screenで人間が操作し、
  開発者workstationのMinecraft／Scratch／Python／WireScopeから検証する`dev-integration`の現行runbook
